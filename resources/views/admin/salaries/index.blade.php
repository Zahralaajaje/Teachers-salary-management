        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('admin.salaries.create') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{ __('New salary') }}</span>
                </a>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-salary" cellspacing="0"
                    width="100%">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        ...
                        <tr data-entry-id="{{ $salary->id }}">
                            ...
                            <td>
                                <a href="{{ route('admin.salaries.edit', $salary->id) }}" class="btn btn-info">
                                    <i class="fa fa-pencil-alt"></i>
                                </a>
                                <form onclick="return confirm('are you sure ? ')" class="d-inline"
                                    action="{{ route('admin.salaries.destroy', $salary->id) }}" method="POST">
                                    @csrf
                                    @method('delete')
...
<script>
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.salaries.mass_destroy') }}",
