...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-header py-3 d-flex">
            <h1 class="h3 mb-0 text-gray-800">{{ __('create teacher') }}</h1>
            <div class="ml-auto">
            ...
            <form action="{{ route('admin.teachers.update', $teacher->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="nationality_id" class="form-control" id="nationality">
                        ...
                        <option {{ $id==$teacher->nationality->id ? 'selected' : null }} value="{{ $id }}">{{
                            $nationality }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date" placeholder="{{ __('date') }}" name="birth_date"
                        value="{{ old('date', $teacher->birth_date) }}" />
                </div>
